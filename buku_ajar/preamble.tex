...
% --- Code Listings untuk C# (Unity) ---
\usepackage{listings}
\usepackage{xcolor}

% Definisi warna untuk syntax highlighting
\definecolor{csred}{rgb}{0.6,0,0}
\definecolor{csgreen}{rgb}{0.25,0.5,0.35}
\definecolor{cspurple}{rgb}{0.5,0,0.35}
\definecolor{csdocblue}{rgb}{0.25,0.35,0.75}
\definecolor{codegray}{rgb}{0.5,0.5,0.5}
\definecolor{codebg}{rgb}{0.95,0.95,0.95}

% Style untuk C# code (Unity)
\lstdefinestyle{csharptyle}{
  language=C,
  morekeywords={void, int, float, bool, string, public, private, protected, class, new, this, return, if, else, for, foreach, while, var, using, namespace, true, false, null, Vector3, GameObject, MonoBehaviour, Rigidbody, Transform, Collider},
  basicstyle=\ttfamily\small,
  keywordstyle=\color{cspurple}\bfseries,
  stringstyle=\color{csred},
  commentstyle=\color{csgreen},
  numbers=left,
...
\lstset{style=csharptyle}

% Environment untuk C# code (Unity) - nama unitycode untuk menghindari konflik dengan \sharp
\lstnewenvironment{unitycode}[1][]{%
  \lstset{style=csharptyle}%
  \ifx\relax#1\relax\else\lstset{#1}\fi
}{}%
...
% Command untuk highlight istilah game/Unity
\newcommand{\unity}[1]{\textbf{\textit{#1}}}

% Command untuk code inline
\newcommand{\code}[1]{\texttt{#1}}

% Command untuk class/type name
...
\newcommand{\keyword}[1]{\textcolor{cspurple}{\texttt{\textbf{#1}}}}

% Box placeholder gambar (sumber eksternal) - tampilkan caption + sumber
\newcommand{\figuresourcebox}[2]{%
  \begin{tcolorbox}[
    width=#1,
    colback=gray!5,
    colframe=gray!60,
  ...
  \centering\small
  \textbf{#2}\\[0.8em]
  Gambar diambil dari: Unity Learn - Roll a Ball Tutorial\\
  \url{https://learn.unity.com/course/roll-a-ball}
  \end{tcolorbox}%
}
...
% Mengurangi underfull hbox di tabel
